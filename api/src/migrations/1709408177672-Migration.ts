...
export class Migration1709408177672 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`polls\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`text\` text NOT NULL, \`ops\` longtext NULL, \`answers\` int NOT NULL DEFAULT '0', \`expiresAt\` timestamp NULL, \`createdByUserId\` int(11) UNSIGNED NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
